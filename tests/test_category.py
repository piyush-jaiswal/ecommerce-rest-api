...
class TestCategory:
    ...
    def create_category(self, create_authenticated_headers):
        def _create(name, headers=None):
            ...
            return self.client.post('/category/create', json={'name': name}, headers=headers)
        return _create
    ...
    def test_update_category(self, create_authenticated_headers, create_category):
        ...
        data = response.get_json()
        cat_id = data['id']  
        update_resp = self.client.put(f'/category/{cat_id}/update', json={'name': 'NewName'}, headers=headers)
    ...
    def test_create_category_expired_token(self):
        ...
        response = self.client.post('/category/create', json={'name': 'TestExpired'}, headers=headers)
    ...
    def test_create_category_invalid_token(self):
        ...
        response = self.client.post('/category/create', json={'name': 'TestInvalid'}, headers=headers)
    ...
    def test_update_category_expired_token(self, create_category, create_authenticated_headers):
        ...
        update_resp = self.client.put(f'/category/{cat_id}/update', json={'name': 'UpdatedName'}, headers=expired_headers)
    ...
    def test_update_category_invalid_token(self, create_category, create_authenticated_headers):
        headers = create_authenticated_headers()
        ...
        update_resp = self.client.put(f'/category/{cat_id}/update', json={'name': 'UpdatedName'}, headers=invalid_headers)
    ...
    def test_update_category_missing_token(self, create_category, create_authenticated_headers):
        ...
        update_resp = self.client.put(f'/category/{cat_id}/update', json={'name': 'UpdatedName'})
    ...
    def test_delete_category_expired_token(self, create_category, create_authenticated_headers):
        headers = create_authenticated_headers()
    ...
    def test_delete_category_invalid_token(self, create_category, create_authenticated_headers):
        headers = create_authenticated_headers()
    ...
    def test_delete_category_missing_token(self, create_category, create_authenticated_headers):
        headers = create_authenticated_headers()
